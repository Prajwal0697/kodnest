        ...
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: 'white' }}>
            <nav style={{
                ...
                <div style={{ display: 'flex', gap: '32px' }}>
                    <NavLink to="/project2/builder" style={({ isActive }) => ({
                        textDecoration: 'none',
                    ...
                    <NavLink to="/project2/preview" style={({ isActive }) => ({
                        textDecoration: 'none',
                        color: isActive ? 'var(--color-primary)' : '#666666',
                        fontWeight: isActive ? 600 : 400,
                        fontSize: '14px'
                    ...
                    <NavLink to="/project2/rb/proof" style={({ isActive }) => ({
                        textDecoration: 'none',
                        color: isActive ? 'var(--color-primary)' : '#666666',
                        fontWeight: isActive ? 600 : 400,
                        fontSize: '14px'
                ...
                <div style={{ width: '140px', display: 'flex', justifyContent: 'flex-end' }}>
                    <a href="/project2/rb/01-problem" style={{ fontSize: '12px', color: '#999', textDecoration: 'none' }}>
                        Build Track ↗
                    </a>
                </div>
            </nav>
